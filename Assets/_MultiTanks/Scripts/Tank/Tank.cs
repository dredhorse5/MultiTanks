...
public class Tank : NetworkBehaviour
{
    ...
    public void SetGun(int index)
    {
        ...
        CameraTarget.FollowTarget = gun.transform;#1#
    }
    public void SetBody(int index)
    {
        ...
        NetworkServer.Spawn(_bodyTankObject.gameObject,gameObject);#1#
        
        /*
        _bodyTankObject.transform.localPosition = Vector3.zero;#1#
